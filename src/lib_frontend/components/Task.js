...
export default props => {
    ...
    const descStyle = props.doneAt !== null ?//Se a descricão da tarefa estiver marcada ou diferente de nulo
        { textDecorationLine: 'line-through' } : {} // então marca a descrição com uma linha , se não não acontece nada ( {} )
